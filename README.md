...
- To acquire additional data, kindly retrieve the necessary files from [iFashion-cloud](https://pan.ustc.edu.cn/share/index/9a6c81f0d0aa40b5b237) and [Polyvore-cloud](https://pan.ustc.edu.cn/share/index/0d531c88bcfd4b7bbc55) and put them into corresponding data path, respectively. Each source comprises two files and one folder.
...
1. Download item information `item_info.npy` from [here](https://pan.ustc.edu.cn/share/index/c2a19300c0e34e42bd19) with the format:
    ```python
    {
        iid1:{
